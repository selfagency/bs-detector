...
/**
 * Utility functions to support using chrome extensions.
 * To be included by Gulp when building to the Chrome platform.
...
function ext_onDomLoadAddListener(function callback, object filter) {
    return chrome.webNavigation.onDOMContentLoaded.addListener(callback, filter);
}
